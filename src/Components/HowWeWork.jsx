        ...
        <div className="wrapper relative z-10">
          <div className="text-center mb-12">
            <h1 className="main-title" data-aos="fade-up">
              Invest in your Goals with ViQantAI
            </h1>
          ...
          <section className="grid md:grid-cols-2 gap-10">
            ...
            <div className=" h-full flex flex-col gap-5">
              ...
              <p className="desc" data-aos="fade-right">
                At ViQantAI, we collaborate closely with clients to understand
          ...
          <section className="my-16">
            ...
            <p className="desc" data-aos="fade-up">
              At ViQantAI, our vision is to be the most advanced AI-driven
          ...
          <section>
            ...
            <p className="desc" data-aos="fade-up">
              At ViQantAI, we believe that exceptional achievements are born
