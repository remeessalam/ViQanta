...
import mlbannerimg from "../assets/images/services/mlbannerimg.jpg";
import mlimg1 from "../assets/images/services/mlimg1.jpg";
import mlimg2 from "../assets/images/services/mlimg2.jpg";
import cloudcomputingbannerimg from "../assets/images/services/cloudcomputingbannerimg.jpg";
import cloudcomputingimg1 from "../assets/images/services/cloudcomputingimg1.jpg";
import cloudcomputingimg2 from "../assets/images/services/cloudcomputingimg2.jpg";
import nlpbannerimg from "../assets/images/services/nlpbannerimg.jpg";
import nlpimg1 from "../assets/images/services/nlpimg1.jpg";
import nlpimg2 from "../assets/images/services/nlpimg2.jpg";
import cloudmigrationbannerimg from "../assets/images/services/cloudmigrationbannerimg.jpg";
import cloudmigrationimg1 from "../assets/images/services/cloudmigrationimg1.jpg";
import cloudmigrationimg2 from "../assets/images/services/cloudmigrationimg2.jpg";
...
`,
  ...
  },
  {
    ...
    secondHeading:
      "How our company will Help you in the Era of Machine Learning",
    secondHeading_subheading: "Service Outcomes",
    services: [
      {
        title: "Custom ML Model Development",
        description:
          "Tailored algorithms designed to address your specific business challenges.",
      },
      {
        title: "Predictive Analytics",
        description:
          "Harness data to forecast trends and optimize decision-making processes.",
      },
      {
        title: "Scalable Integration",
        description:
          "Seamlessly deploy ML models into existing systems with robust performance.",
      },
    ],
  ...
  {
    id: 14,
    bannerimg: cloudcomputingbannerimg,
    ...
    secondHeading:
      "How our company will Help you in the Era of Cloud Computing",
    secondHeading_subheading: "Service Outcomes",
    services: [
      {
        title: "Flexible Cloud Infrastructure",
        description:
          "Scalable solutions for storage, computing, and networking tailored to your business.",
      },
      {
        title: "Enhanced Security",
        description:
          "Quantum-safe encryption and robust protocols to protect your data in the cloud.",
      },
      {
    ...
    services: [
      {
        ...
        description:
          "AI-driven bots for 24/7 customer support across multiple platforms.",
      },
      {
        title: "Sentiment Analysis",
        description:
          "Analyze user feedback to understand emotions and improve engagement.",
      },
      {
        title: "Text Analytics",
        description:
          "Extract actionable insights from unstructured data with advanced NLP models.",
      },
    ],
  ...
  {
    id: 16,
    bannerimg: cloudmigrationbannerimg,
    ...
    secondHeading:
      "How our company will Help you in the Era of Cloud Migration",
    secondHeading_subheading: "Service Outcomes",
    services: [
      {
        title: "Seamless Data Migration",
        description:
          "Securely transfer data to the cloud with minimal downtime.",
      },
      {
        title: "Application Optimization",
        description:
          "Refactor and optimize applications for cloud-native performance.",
      },
      {
        title: "Cost-Effective Transition",
        description:
          "Strategize migrations to maximize ROI and reduce operational costs.",
      },
    ],
